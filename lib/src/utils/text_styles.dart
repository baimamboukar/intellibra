...
class TextStyles {
  ...
  static TextStyle get unSelectedCategory =>
      myProfile.copyWith(color: Palette.secondary);
  static TextStyle get selectedCategory =>
      myProfile.copyWith(color: Palette.light);
  ...
  static TextStyle get awarenessBackToTop => GoogleFonts.roboto(
  ...
  static TextStyle get awarenessReply => GoogleFonts.roboto(
        color: Palette.primary.withOpacity(0.4),
        fontWeight: FontWeight.w400,
  ...
  static TextStyle get awarenessCommentHeader => awarenessBackToTop.copyWith(
      fontSize: 17.sp, color: Palette.primary.withOpacity(0.5));
  static TextStyle get awarenessDeleteComment => awarenessBackToTop.copyWith(
      fontSize: 14.sp,
      fontWeight: FontWeight.w500,
